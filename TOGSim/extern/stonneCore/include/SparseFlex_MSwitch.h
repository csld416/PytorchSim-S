...
#ifndef __SPARSEFLEXMSwitch__h
#define __SPARSEFLEXMSwitch__h
...
class SparseFlex_MSwitch : public Unit {
private:
...
public:
    SparseFlex_MSwitch(id_t id, std::string name, int num, Config stonne_cfg);
    SparseFlex_MSwitch(id_t id, std::string name, int num, Config stonne_cfg, Connection* outputConnection,
    ...
    void setMemoryConnection(Connection* memoryConnection);
